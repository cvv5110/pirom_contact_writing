...
A critical artifact in transient modeling of hypersonic TPS responses is TCRs. Due to manufacturing limitations, when two solids are brought together to form an interface, the true solid-to-solid contact area between them is generally a small fraction of the apparent area over which they meet {MINGES1970}. The net effect of imperfect contact is the formation of a temperature discontinuity at the interface that is in general challenging to predict, and that significantly affects the heat transfer across the interface. For example, in Ref. {X}, the authors demonstrated that the TCRs at the interface of a TPS can vary by orders of magnitude depending on the surface roughness, contact pressure, and temperature. This variability in TCRs can lead to significant uncertainties in the predicted temperature distribution within the TPS, and thus compromise its effectiveness in protecting the hypersonic vehicle {X}.
