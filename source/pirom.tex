...
\begin{subequations}
    \begin{align}
        ...
        \Delta\btheta_i &= \frac{1}{\left|\Gamma_i\right|}\sum_{m\in\cF_i^-}\int_{\Gamma_i\cap\partial E_m} \vphi_m^\top\vu_m d\Gamma_i - \frac{1}{\left|\Gamma_i\right|}\sum_{n\in\cF_i^+}\int_{\Gamma_i\cap\partial E_n} \vphi_n^\top\vu_n d\Gamma_i
    \end{align}
\end{subequations}
...
Define the interface average temperature as new coarse-grained variables,
\begin{subequations}
    \begin{align}
        \btheta_i^{i}(t) &= \frac{1}{\left|\Gamma_i\right|}\sum_{m\in\cF_i^-}\int_{\Gamma_i\cap\partial E_m} \vphi_m^\top\vu_m d\Gamma_i\\
        \btheta_i^{i+1}(t) &= \frac{1}{\left|\Gamma_i\right|}\sum_{n\in\cF_i^+}\int_{\Gamma_i\cap\partial E_n} \vphi_n^\top\vu_n d\Gamma_i
    \end{align}
\end{subequations}
and thus,
\begin{subequations}
    \begin{align}
        \Delta\btheta_i(t) &= \btheta_i^{i}(t) - \btheta_i^{i+1}(t)\\
        \btheta_i^{-}(t) &= C_i^{-}\vu(t)\\
        \btheta_i^{+}(t) &= C_i^{+}\vu(t)\\
